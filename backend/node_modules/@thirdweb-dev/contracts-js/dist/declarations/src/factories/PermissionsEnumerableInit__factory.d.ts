...
export declare class PermissionsEnumerableInit__factory extends ContractFactory {
    ...
    static readonly bytecode = "0x6080604052348015600f57600080fd5b50603f80601d6000396000f3fe6080604052600080fdfea2646970667358221220866145dc48a610a4f1ea3e7ec4dc407b1fcbaf06fb6ac0289814cbae741173c564736f6c634300080c0033";
    static readonly abi: {
        anonymous: boolean;
        inputs: {
            indexed: boolean;
