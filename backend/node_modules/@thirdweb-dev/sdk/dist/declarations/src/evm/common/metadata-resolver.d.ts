 ...
 * @param storage
 */
export declare function fetchContractMetadataFromAddress(address: Address, provider: providers.Provider, storage: ThirdwebStorage, sdkOptions?: SDKOptions): Promise<{
    name: string;
